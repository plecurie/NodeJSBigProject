...
export class BulkDatabaseService {
    ...
    public async importProducts(products_filename = 'InputProducts.xlsx',
        ...
        for (let i = 0; i < Object.keys(data).length; i++) {
            ...
            const criteria = Object.keys(names).map(obj => {
                return {name: obj, value: names[obj], familyName: ""} as Criteria;
            });
            ...
            let product: Map<String, Criteria[]> = new Map<String, Criteria[]>([
                ["type", "product"],
